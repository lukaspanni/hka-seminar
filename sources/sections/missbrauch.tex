...
Allerdings können über einen Replay-Angriff korrekt verschlüsselte, manipulierte Standortdaten, auf Apples Server gelangen.
...
Um einen solchen Angriff durchzuführen, zeichnet ein Angreifer zunächst die Advertisement-Pakete eines Lost Device auf.
Anschließend kann der Angreifer die selben Advertisement-Pakete zu einer anderen Zeit oder an einem anderen Ort senden.
Geräte in der Nähe des Angreifers empfangen diese Pakete und erstellen korrekte Location Reports.
Diese werden ebenfalls korrekt authentifiziert auf Apples Server hochgeladen.
Bei einer Anfrage erhält das Owner Device beispielsweise die korrekten und die manipulierten Standortdaten.
Das Owner Device kann nicht bestimmen, welche Informationen korrekt sind.
