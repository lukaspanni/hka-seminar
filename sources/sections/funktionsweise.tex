...
Beim initialen Pairing mit einem Owner Device, werden vom Accessory und dem Owner Device gemeinsam ein \ac{ECC}-Schlüssel und zwei symmetrische Schlüssel berechnet.
Diese Schlüssel entsprechen im Wesentlichen dem Master Beacon Key, der für die Ableitung der Advertising Keys verwendet wird \cite{Apple_FindMySpec}.
Auf den konkreten Prozess des Pairing und die Unterschiede zwischen Accessories und anderen Apple-Geräten wird hier nicht weiter eingegangen.
